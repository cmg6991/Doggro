...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        /// Binary operator 에러가 있네 
        /// 1. inl에 있는 파일을 여기로 옮기고 inline을 사용한다.
        // Binary operators
        ...
        struct Matrix : public XMFLOAT4X4
        {
            ...
            inline void Invert(Matrix& result) const noexcept
            {
                using namespace DirectX;
        ...
        struct Quaternion : public XMFLOAT4
        {
            ...
            inline Quaternion CreateFromYawPitchRoll(const Vector3& angles) noexcept
            {
                using namespace DirectX;
                Quaternion R;
            ...
            inline static Quaternion CreateFromRotationMatrix(const Matrix& M) noexcept
            {
                using namespace DirectX;
